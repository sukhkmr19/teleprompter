...
class _CameraExampleHomeState extends State<CameraExampleHome> {
  ...
  void _toEnd() {
    // NEW
    Timer.periodic(
        Duration(milliseconds: 1000), (Timer t) => checkForNewSharedLists());
  }
  ...
  Future<String> startVideoRecording() async {
    ...
    final String filePath = '$dirPath/${"sukh"}.mp4';
  ...
  checkForNewSharedLists() {
    ...
    if (value != _scrollController.position.maxScrollExtent) {
      _scrollController.position.moveTo(value + 3.0, curve: Curves.easeIn);
    } else {}
//    _scrollController.animateTo(
//     _scrollController.position.moveTo(to)0, // NEW
//      duration: Duration(microseconds: 2), // NEW
